 ...
 * Update URI:        https://github.com/rfluethi/Training-Translation-Tracker
...
require_once TTT_PLUGIN_DIR . 'includes/class-status.php';
require_once TTT_PLUGIN_DIR . 'includes/class-styles.php';
